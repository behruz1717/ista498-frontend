...
(function () {
  const translations = {
    en: {
      ...
      serve: 'Serve',
      close: 'Close',
      total_waiting_today: 'Total Waiting Today',
      ahead_of_you: 'Ahead of You',
      all_set_title: 'All Set!!!',
      all_set_body: 'Thank you for using QueueLeaf.',
      you_left_title: 'You have left the queue',
      you_left_body: 'We hope to see you again.',
    ...
    uz: {
      ...
      status_called_banner: 'Sizni chaqirishyapti! Iltimos, kelib turing.',
      ...
      modal_people_ahead: 'Oldingizdagi odamlar',
      modal_avg_service: 'O‘rtacha xizmat vaqti',
      average_service: 'O‘rtacha xizmat',
      ...
      serve: 'Xizmat qilish',
      close: 'Yopish',
      total_waiting_today: "Bugun navbatda kutayotganlar",
      ahead_of_you: 'Oldingizdagi odamlar',
      all_set_title: 'Barchasi tayyor!!!',
      all_set_body: 'QueueLeafdan foydalanganingiz uchun rahmat.',
      you_left_title: 'Siz navbatdan chiqib ketdingiz',
      you_left_body: 'Yana ko‘rishishni xohlaymiz.',
      join_again: 'Yana qo‘shilish',
    ...
    ru: {
      ...
      average_service: 'Среднее обслуживание',
      modal_queue: 'Очередь',
      ...
      serve: 'Обслужить',
      close: 'Закрыть',
      total_waiting_today: 'Всего ожидающих сегодня',
      ahead_of_you: 'Перед вами',
      all_set_title: 'Готово!!!',
      all_set_body: 'Спасибо за использование QueueLeaf.',
      you_left_title: 'Вы покинули очередь',
      you_left_body: 'Надеемся увидеть вас снова.',
      join_again: 'Присоединиться снова',
